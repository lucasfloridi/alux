...
EndIf
cString += '<DDDPrestador>'+ IIF(FisGetTel( SM0->M0_TEL,,,.T. )[2] == "", '0', substr(FisGetTel( SM0->M0_TEL,,,.T. )[2], 1, 3)) +'</DDDPrestador>'
cString += '<TelefonePrestador>'+ IIF(FisGetTel( SM0->M0_TEL,,,.T. )[3] == "", '0', substr(FisGetTel( SM0->M0_TEL,,,.T. )[3], 1, 15)) +'</TelefonePrestador>'
