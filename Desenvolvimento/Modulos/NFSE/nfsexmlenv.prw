...
static function prest()
	...
	if( type( "oSigamatX" ) == "U" )
		...
		cString	+= "<ddd>" + IIF(fisGetTel( SM0->M0_TEL,,,.T. )[2] == "", '0', substr(fisGetTel( SM0->M0_TEL,,,.T. )[2], 1, 3)) + "</ddd>"
		cString	+= "<telefone>" + IIF(fisGetTel( SM0->M0_TEL,,,.T. )[3] == "", '0', substr(fisGetTel( SM0->M0_TEL,,,.T. )[3], 1, 15)) + "</telefone>"
		...
		cString	+= "<ddd>" + IIF(fisGetTel( oSigamatX:M0_TEL,,,.T. )[2] == "", '0', substr(fisGetTel( oSigamatX:M0_TEL,,,.T. )[2], 1, 3)) + "</ddd>"
		cString	+= "<telefone>" + IIF(fisGetTel( oSigamatX:M0_TEL,,,.T. )[3] == "", '0', substr(fisGetTel( oSigamatX:M0_TEL,,,.T. )[3], 1, 15)) + "</telefone>"
		cString	+= "<simpnac>" + cMVOPTSIMP + "</simpnac>"
...
Static Function tomador( aDest )
	...
	If !lSemTomador 		
		...
		cString	+= "<ddd>" + IIF(fisGetTel( aDest[13],,,.T. )[2] == "", '0', substr(fisGetTel( aDest[13],,,.T. )[2], 1, 3)) + "</ddd>"
		cString	+= "<telefone>" + IIF(fisGetTel( aDest[13],,,.T. )[3] == "", '0', substr(fisGetTel( aDest[13],,,.T. )[3], 1, 15)) + "</telefone>"
