...
/*/
//--------------------------------------------------------------------
User Function UPDZZSD3( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgInfo( "Atualização realizada.", "UPDZZSD3" )
				Else
					MsgStop( "Atualização não realizada.", "UPDZZSD3" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	'Integ. DGF?'															, ; //X3_TITSPA
	'Integ. DGF?'															, ; //X3_TITENG
	'Integ. DGF?'															, ; //X3_DESCRIC
	'Integ. DGF?'															, ; //X3_DESCSPA
	'Integ. DGF?'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Integ. DGF?' )

aHlpEng := {}
aAdd( aHlpEng, 'Integ. DGF?' )

aHlpSpa := {}
aAdd( aHlpSpa, 'Integ. DGF?' )

PutSX1Help( "PD3_ZZINT  ", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "D3_ZZINT" )

aHlpPor := {}
aAdd( aHlpPor, 'Hist. DGF' )

aHlpEng := {}
aAdd( aHlpEng, 'Hist. DGF' )

aHlpSpa := {}
aAdd( aHlpSpa, 'Hist. DGF' )

PutSX1Help( "PD3_ZZDTINT", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "D3_ZZDTINT" )
...
PutSX1Help( "PD3_ZZID   ", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "D3_ZZID" )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDZZSD3" ) ) ) ;
